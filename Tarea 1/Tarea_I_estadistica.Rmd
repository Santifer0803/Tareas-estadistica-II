...
```{r kernel_normal}
D <- density(BaseSalarios$Cuotas, kernel = "gaussian")
hist(
  BaseSalarios$Cuotas,
  main = "Kernel Normal",
  freq = FALSE,
...
D <- density(BaseSalarios$Cuotas, kernel = "epanechnikov")
hist(
  BaseSalarios$Cuotas,
...
```{r kernel_coseno}
D <- density(BaseSalarios$Cuotas, kernel = "cosine")
hist(
  BaseSalarios$Cuotas,
  main = "Kernel coseno",
  freq = FALSE,
...
D <- density(BaseSalarios$Cuotas, kernel = "rectangular")
hist(
  BaseSalarios$Cuotas,
...
```{r kernel_triangular}
D <- density(BaseSalarios$Cuotas, kernel = "triangular")
hist(
  BaseSalarios$Cuotas,
...
```{r grafico_kernels}
kernels <- c("biweight", "gaussiano", "epanechnikov", "coseno", "rectangular", "triangular")

D1 <- density(BaseSalarios$Cuotas, kernel = "biweight", bw = h)
D2 <- density(BaseSalarios$Cuotas, kernel = "gaussian")
D3 <- density(BaseSalarios$Cuotas, kernel = "epanechnikov")
D4 <- density(BaseSalarios$Cuotas, kernel = "cosine")
D5 <- density(BaseSalarios$Cuotas, kernel = "rectangular")
D6 <- density(BaseSalarios$Cuotas, kernel = "triangular")
hist(
  BaseSalarios$Cuotas,
...
lines(D1,lwd=2,lty=1,col="darkolivegreen")
lines(D2,lwd=2,lty=1,col="darkorchid")
lines(D3,lwd=2,lty=1,col="skyblue2")
lines(D4,lwd=2,lty=1,col="coral2")
lines(D5,lwd=2,lty=1,col="lightslateblue")
lines(D6,lwd=2,lty=1,col="indianred4")
